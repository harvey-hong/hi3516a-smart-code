...
extern bool read_short_term_ref_pic_set(const seq_parameter_set* sps,
                                        bitreader* br,
                                        ref_pic_set* out_set,
...
de265_error seq_parameter_set::read(bitreader* br)
{
  int vlc;
  ...
  for (int i = 0; i < num_short_term_ref_pic_sets; i++) {
    ...
    bool success = read_short_term_ref_pic_set(this,br,
                                               &ref_pic_sets[i], i,
                                               ref_pic_sets,
                                               false);
  ...
  if (sps_range_extension_flag) {
    de265_error err = range_extension.read( br);
...
de265_error sps_range_extension::read(bitreader* br)
{
