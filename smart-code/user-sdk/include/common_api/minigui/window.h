...
/* 
 * $Id: window.h,v 1.153 2005/09/04 05:07:28 weiym Exp $
 *
...
//!xiaoyi,add, define mouse wheel message
#define MSG_MOUSEWHEEL 	MSG_USER + 100
...
#define MSG_CLEARPAINT       0x00B5			//add by 刘宇
...
#define MSG_DT_MOUSEWHEEL  (MSG_MOUSEWHEEL+MSG_DT_MOUSEOFF)
 ...
 *        through the argument of dwAddData when creating the ScrollView 
...
//add by liuyu date 2015-02-05 start
#define MSG_GETVALIDTEXTLENGTH   0x0160
//add by liuyu date 2015-02-05 end

#define MSG_IME_SET_BMP_CHAR   0x0201
#define MSG_IME_SET_BMP_NUMBER   0x0202
#define MSG_IME_SET_BMP_CONTROL   0x0203
#define MSG_IME_SET_BMP_SYMBOL   0x0204
#define MSG_IME_SET_BMP_BG   0x0205
#define MSG_IME_SET_BG_COLOR   0x0206

#if 1
#define MSG_IME_GET_NUM_WND 0x0207
#define MSG_IME_CHANGE_WND  0x0208
#define MSG_IME_GET_PINYIN_WND 0x218

#define MSG_IME_CHANGE_ENTER_IMAGE 0x0209   //下面四个消息同时软键盘进行特殊控件的换图
#define MSG_IME_CHANGE_CHAR_BACKSPACE_IMAGE 0x0210
#define MSG_IME_CHANGE_SHIFT_IMAGE 0x0211
#define MSG_IME_CHANGE_SPACE_IMAGE 0x0212   

#define MSG_IME_CHANGE_PINYIN_INPUT_IMAGE 0x0220
#define MSG_IME_CHANGE_PINYIN_OUTPUT_IMAGE 0x221
#define MSG_IME_CHANGE_PINYIN_PRE_PAGE_IMAGE 0x222
#define MSG_IME_CHANGE_PINYIN_NEXT_PAGE_IMAGE 0x223
#define MSG_IME_CHANGE_PINYIN_BG_IMAGE 0x224
#define MSG_IME_CLOSE_PINYIN_WND 0x225

#define MSG_IME_ENABLE_PINYIN 0x226
#define MSG_IME_DISABLE_PINYIN 0x227

//这个消息是桌面窗口发送的
#define MSG_IME_NOTIFY_NUM_WIN_CLOSE 0x0213 //发送给数字窗口通知你该发送你关闭了的消息给编辑框
...
#define MSG_RESOLUTION_CHANGED          (MSG_USER + 1)
#define MSG_LANGUAGE_CHANGED            (MSG_USER + 2)
#define MSG_LIVE_POLL                   (MSG_USER + 3)  //??
#define MSG_LIVE_UPDATE_ICON            (MSG_USER + 4)  
#define MSG_PB_RESUME_FOCUS             (MSG_USER + 5)  
#define MSG_PB_UPDATE_WINDOW                     (MSG_USER + 6)
#define MSG_BACKBUP_UPDATE_PROGRESS  (MSG_USER + 7)
#define MSG_HARD_DISK_UPDATE_INFO_FOR_ALL   (MSG_USER + 8) //?????Щ?
#define MSG_HARD_DISK_UPDATE_INFO_FOR_ONE   (MSG_USER + 9) //??????Щ?
#define MSG_SHOWTIP         (MSG_USER + 10)                 //add by  ??tip
#define MSG_LOGIN_INVALID   (MSG_USER + 11)  //add by lijibin
#define MSG_FAILE (MSG_USER + 12)       //add by  豸????????
#define MSG_SUCCESS (MSG_USER + 13)     //add by  豸????????
#define MSG_CALENDAR            (MSG_USER + 14) //add by  ???ж?????μ?????
#define MSG_SYSTEM_TIME   (MSG_USER + 15)       //add by    bar???
#define MSG_BACKUP_TIP_SHOW     (MSG_USER + 16) //add by    ??tip?

#define MSG_CHANNEL_CONFIG_UPDATE (MSG_USER + 17)

#define MSG_VIDEO_STD_CHANGED   (MSG_USER + 18)
#define MSG_SMTP_SHOW_MESSAGE     (MSG_USER + 19)  // change by ljx date 2015.07.28

#define MSG_POINT_DAY		0x1FFF  	//add by 刘宇

#define MSG_KILL_LOCK       0x2FFF      //add by liuyu date 2015-05-21

#define MSG_CHECK_SAVE_EXIT       0x3FFF      //add by liuyu date 2015-05-22

//add by liuyu date 2015-04-29 start
#define MSG_PLAYBACK_CHANNEL_INFO_UPDATE	(MSG_USER + 20)
//add by liuyu date 2015-04-29 end
#define MSG_RESET_ADMIN			(MSG_USER + 21) // add by ljx date 2015.07.28
#define MSG_LOGIN_AGAIN			(MSG_USER + 22) // add by ljx date 2015.07.28

#define MSG_LOCK_SCREEN                      (MSG_USER +23) //modified by zgf 20151030
#define MSG_DISK_SHOW_MESSAGE 		 (MSG_USER +24) //add by mjq 20151123
#define MSG_POINT_GROUP     		(MSG_USER +25)      //add by lz 20160128 start-end;
#define MSG_CHANNEL_SEARCH_CLEANUP     		(MSG_USER +26) //add by qqy, at 2016-07-06 14:33:08

#define MSG_DISK_NO_FORMAT_MESSAGE 		 (MSG_USER + 27)        // add by linhh 20160729 
#define MSG_DISK_SHOW_FORMAT_PROCESS 		 (MSG_USER + 28)        // add by linhh 20160729 

 //add by qqy,start at 2016-08-11 09:22:58
#define MSG_CHANNEL_SEARCH_MANUAL_CONNECT     		(MSG_USER +29) 
#define MSG_CHANNEL_SEARCH_REFRESH_LIST     		(MSG_USER +30) 
#define MSG_CHANNEL_SEARCH_UPDATE_STATUS     		(MSG_USER +31) 
 //add by qqy,end at 2016-08-11 09:23:00


 //add by qqy,start at 2016-08-16 11:15:01
#define MSG_BACKUP_SHOW_SEARCH_FILE   		(MSG_USER +32) 
#define MSG_BACKUP_SHOW_PROBE_USB_DEV     		(MSG_USER +33) 
#define MSG_PLAYBACK_SHOW_CH_COLO    		(MSG_USER +34) 
#define MSG_UPGRADE_SHOW_PROGRESS     				(MSG_USER +35) 
 //add by qqy,end at 2016-08-16 11:15:04
 
#define MSG_CHANNEL_STATUS_SHOW_INFO     		(MSG_USER +36)  //add by qqy, at 2016-08-19 18:34:46
#define MSG_HARD_DISK_LIST_SHOW_INFO 		(MSG_USER +37)		//add by lmw 2016 10 21

//add by khs 2017.3.24 start
#define MSG_CHANNEL_PRO_CONFIG_REFRESH_LIST     		(MSG_USER +38) 
#define MSG_CHANNEL_PRO_SEARCH_REFRESH_LIST     		(MSG_USER +39) 
//add by khs 2017.3.24 end

#define MSG_UPGRADE_SHOW_SUB_PROGRESS     				(MSG_USER +40)  //add by qqy, at 2017-04-18 12:02:03
#define MSG_SHOW_THE_DDNS_CONNECT_STATUS     			(MSG_USER +41) //add by lmw 2017 4 18
 ...
 */               
MG_EXPORT BOOL GUIAPI PeekMessage (PMSG pMsg, HWND hWnd, int iMsgFilterMin, 
...
#define WS_EX_LOCK_BUTTON		0x00000500L		//add by liuyu date 2015-05-21
...
#define WS_EX_STANDARD_PARTITION 0x02000000L   //标准分割，只需要指定区域 行列数目
#define WS_CUSTOM_PARTITION 	0x04000000L   //自定义分割，需要指定区域，以及行列分割比例
...
/**
 * \fn int DefaultMainWinProc (HWND hWnd, int message,
                WPARAM wParam, LPARAM lParam)
 ...
 */
MG_EXPORT int GUIAPI DefaultMainWinProc (HWND hWnd, int message, 
                WPARAM wParam, LPARAM lParam);
...
/**
 * \fn int DefaultControlProc (HWND hWnd, int message, 
                    WPARAM wParam, LPARAM lParam)
 ...
 */
MG_EXPORT int GUIAPI DefaultControlProc (HWND hWnd, int message, 
                WPARAM wParam, LPARAM lParam);
...
MG_EXPORT DWORD GUIAPI SetWindowStyle (HWND hWnd, DWORD dwStyle);
/**
...
//added by xiaoyi 091126
MG_EXPORT HWND GUIAPI KillFocusChild (HWND hWnd);

#define KillFocus KillFocusChild
//added by xiaoyi 091126
...
#define CTRL_BN_CAPTION_NORMAL		37
#define CTRL_BN_CAPTION_HL		38

#define CTRL_STATIC_CAPTION_NORMAL		39
#define CTRL_STATIC_CAPTION_HL		40

#define CTRL_PS_CAPTION_NORMAL		41
#define CTRL_PS_CAPTION_HL		42

#define CTRL_SLE_CAPTION_NORMAL		43
#define CTRL_SLE_CAPTION_HL		44
#define CTRL_SLE_BG		45

#define CTRL_LB_BG		46
#define CTRL_LB_TEXT_NORMAL		47
#define CTRL_LB_TEXT_HL		48
#define CTRL_MC_DAY_BG		49
#define SKB_IME_BG		50


#define  WED_3DBOX_REVERSE_4SB 		51
#define  WEC_3DBOX_DARK_4SB		52
#define  WEC_3DBOX_LIGHT_4SB		53
#define  WEC_3DBOX_NORMAL_4SB		54

#define WEC_SCROLLBAR_BG		55

#define WEC_ITEM_NUMBER             56
...
#define FGC_BUTTON_NORMAL           CTRL_BN_CAPTION_NORMAL
#define FGC_BUTTON_PUSHED           CTRL_BN_CAPTION_HL
...
#define WEC_3DFRAME_LEFT_OUTER_4SB      WED_3DBOX_REVERSE_4SB
#define WEC_3DFRAME_LEFT_INNER_4SB      WEC_3DBOX_DARK_4SB
#define WEC_3DFRAME_RIGHT_OUTER_4SB     WEC_3DBOX_LIGHT_4SB
#define WEC_3DFRAME_RIGHT_INNER_4SB    WEC_3DBOX_NORMAL_4SB
...
#define STOCKBMP_RADIO_BUTTON		  "radio_button"   //add by刘宇
...
MG_EXPORT int GUIAPI GetMenuItemRect (HWND hwnd, HMENU hmnu, 
                int item, PRECT prc);
...
{
    const char* class_name;             /** class name of the control */
...
/**
 * \fn int GUIAPI DefaultDialogProc (HWND hWnd, 
...
#define MB_NONE          0x00000006		//NO BUTTON
...
//added by xiaoyi for message box button bitmap style form here
#define MB_BITMAP                  	     0x00100000
#define MB_BITMAPMASK                  0x00F00000
//to here
