...
/*
 * $Id: common.h,v 1.102 2005/09/04 06:31:18 weiym Exp $
 *
...
/*
 *
 *标准的区域划分，只需要指定长宽列数即可，会平均分配
 *
 *
 */
typedef struct _STPART
{
	int col_num;  //列数
	int line_num;	//行数
}STPART;

typedef STPART* PSTPART;

#define GUI_MAX_LINE_COL_NUM 32

/*
 *
 *自定义的区域划分，需要指定长宽的列数以及每列行的长度，最大支持32*32行列
 *
 *
 */
 
typedef struct _CUSPART
{
	int col_num;
	int line_num;
	int col_dist[GUI_MAX_LINE_COL_NUM];
	int line_dist[GUI_MAX_LINE_COL_NUM];
}CUSPART;

typedef CUSPART* PCUSPART;
...
//KEY UP
#define SCANCODE_KEY_UP                      22

#define SCANCODE_I                      23
#define SCANCODE_INFO                      23
...
#define SCANCODE_VO                      45

#define SCANCODE_C                      46
#define SCANCODE_V                      47
#define SCANCODE_SEQ                      47
...
//////////////////////////////////
//special for dvr , replace f1 - f12
#define SCANCODE_FN                     59
#define SCANCODE_DEV                     60
#define SCANCODE_REC                     61
#define SCANCODE_SEARCH                     62
#define SCANCODE_PLAY_PAUSE                     63
#define SCANCODE_SLOWER                     64
#define SCANCODE_FASTER                     65
#define SCANCODE_STOP                     66
#define SCANCODE_PTZ                     67
#define SCANCODE_MUTE                    68
#define SCANCODE_SWITCH                    87
#define SCANCODE_ALARM_RESET                    88
///////////////////////////////////////////
...
#define SCANCODE_BACKUP                 84
#define SCANCODE_KEY_A					85
...
//xiaoyi,add for mouse wheel, 
#define MASK_MS_WHEEL			0x000F0000
#define MS_WHEELDOWN			0x00010000
#define MS_WHEELUP				0x00020000
//xiaoyi,add for mouse wheel, 
