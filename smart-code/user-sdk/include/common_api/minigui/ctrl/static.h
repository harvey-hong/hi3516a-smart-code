...
#define IB_SETCOLOR		0xF180
#define IB_SETDATA		0xF181

#define IB_SETSTARTEND		0xF182
...
#define INFOBAR_MAX_COLOR_CNT	16

typedef struct tagINFOBAR
{
	int 	start;
	int 	end;
	gal_pixel	color[INFOBAR_MAX_COLOR_CNT];
	char info[1440];
} INFOBAR;

typedef INFOBAR *PINFOBAR;
