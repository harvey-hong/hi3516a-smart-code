...
#define PSM_SETIMAGE            	 			0xF1D3L
#define PSM_SETIMAGE_FOCUS              0xF1D4L
#define PSM_SETHEAD_HIGH         		    0xF1D5L

/* add by ÁõÓî
 *
 *set propsheet title weight ;
 *wParam = title wight;
 *lParam = 0;
 *if wParam > 0 ,set propsheet title wight ,Otherwise use the default values  
 *
 */
#define PSM_PAGETITLE_WIDTH         		    0xF1D6L
