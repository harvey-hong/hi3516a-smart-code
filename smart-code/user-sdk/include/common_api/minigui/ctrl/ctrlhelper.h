...
/*
 * $Id: ctrlhelper.h,v 1.3 2005/09/04 06:06:47 qzlong Exp $
 *
...
/*same as Draw3DThickFrameEx but this function is just for scrollbar only, special color*/
void GUIAPI Draw3DThickFrame4Scrollbar (HDC hdc, HWND hwnd, int l, int t, int r, int b, DWORD flags, gal_pixel fillc);
